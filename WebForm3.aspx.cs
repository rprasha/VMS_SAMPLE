...
namespace WebApplication1
{
    public partial class WebForm3 : System.Web.UI.Page
    {
        ...
        protected void Btn_Search_Click(object sender, EventArgs e)
        {
            ...
            {
                con.Open();
                SqlCommand cmd = new SqlCommand("INSERT INTO TBL_ANSWERPAPER1 VALUES(@CompanyName,@PositionName,@FromDate,@EndDate)", con);
                ...
                cmd.Parameters.AddWithValue("@FromDate", TextStartDate.Text);
                cmd.Parameters.AddWithValue("@EndDate", TextEndDate.Text);
                cmd.ExecuteNonQuery();
                con.Close();
            }
